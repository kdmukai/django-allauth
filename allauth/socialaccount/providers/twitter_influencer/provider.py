...
class TwitterInfluencerAccount(ProviderAccount):
    ...
    def to_str(self):
        screen_name = self.get_screen_name()
        return screen_name or super(TwitterInfluencerAccount, self).to_str()


class TwitterInfluencerProvider(OAuthProvider):
    id = 'twitter_influencer'
    name = 'TwitterInfluencer'
    account_class = TwitterInfluencerAccount
...
provider_classes = [TwitterInfluencerProvider]
