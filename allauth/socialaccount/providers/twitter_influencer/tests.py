...
class TwitterInfluencerTests(OAuthTestsMixin, TestCase):
    provider_id = TwitterInfluencerProvider.id

    def get_mocked_response(self):
        # FIXME: Replace with actual/complete TwitterInfluencer response
